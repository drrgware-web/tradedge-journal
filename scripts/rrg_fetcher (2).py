...
def calc_for_benchmark(bench_sym, config, price_data, sector_stocks, daily_tail, weekly_tail, window):
    ...
    d_ac = calc_rrg_items(price_data, ac_list, bc, bd, daily_tail, window, weekly=False)
    d_ms = calc_rrg_items(price_data, ms_list, bc, bd, daily_tail, window, weekly=False)
    ...
    w_ac = calc_rrg_items(price_data, ac_list, bc, bd, weekly_tail, window, weekly=True)
    w_ms = calc_rrg_items(price_data, ms_list, bc, bd, weekly_tail, window, weekly=True)
