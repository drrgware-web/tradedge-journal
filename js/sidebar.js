...
TE.injectShell = function() {
  ...
  <nav class="sidebar">
    ...
    <div class="sb-item" id="nav-edgepilot" data-tip="Edge Pilot" onclick="nav('edgepilot')">
      <svg viewBox="0 0 24 24"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" fill="none" stroke="currentColor" stroke-width="1.8"/></svg>
    </div>
